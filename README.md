...
- Version: `1.4.0` — Retrieval, Tools & Response Reliability Upgrade
- Public API: OpenAI-compatible provider surface at `/v1`
- Search: focused query planner, ranked results, safe search metadata
- Reliability: multipart provider content extraction and one safe empty-answer retry
- Diagnostics: compact `lifecycle_events` metadata (no outbound webhooks)
